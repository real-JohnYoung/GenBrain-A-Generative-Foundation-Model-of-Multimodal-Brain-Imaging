...
def main():
    ...
    train_file_path = 'Path_To/adni_nc_ad_mci/labels/adni_train_seg_data.csv'
    val_file_path = 'Path_To/adni_nc_ad_mci/labels/adni_val_seg_data.csv'
    test_file_path = 'Path_To/liuyuan_ad_nc_mci_ad/labels/T1_nc_mci_ad_seg_info.csv'
    aug_file_path = 'Path_To/adni_nc_ad_mci/data_aug_labels/data_aug_data.csv'
    ...
    for i in range(0,31):
        ...
        output_root = f'Path_To/adni_nc_ad_mci/results_ft_20k/adni_liuyuan/baseline_data_aug_{i*10}_percent_ft_{ft_step}_random'
