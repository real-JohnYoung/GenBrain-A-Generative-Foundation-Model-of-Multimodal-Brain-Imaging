...
def main(args):
    ...
    transform = True
    dataset = adni_ad_finetune_T1(args.data_path, args.data_label_file, image_data_info, transform=transform)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default=None)# DNI_T1/raw_1d
    parser.add_argument("--data_label_file", type=str, default=None)# adni_train_data.csv
...
# torchrun --nnodes=1 --nproc_per_node=1  finetune_adni_ad_nc_mci_ad_T1_step.py