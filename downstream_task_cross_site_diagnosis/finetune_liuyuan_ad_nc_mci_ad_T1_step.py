...
from model_utils import liuyuan_ad_finetune_T1
...
def main(args):
    ...
    transform = True
    dataset = liuyuan_ad_finetune_T1(args.data_path, args.data_label_file, image_data_info, transform=transform)
    ...
    for epoch in range(0, args.epochs):
        ...
        for data in loader:
            ...
            # Save DiT checkpoint:
            if rank == 0 and ((train_steps+1)%1000==0):
                checkpoint = {
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default=None)# zic : liuyuan_AD/process_data"
    parser.add_argument("--data_label_file", type=str, default=None)# labels/T1_train_data.csv
    parser.add_argument("--data_info", type=str, default=None)# data_info.json
    parser.add_argument("--epochs", type=int, default=1000)
    parser.add_argument("--results_dir", type=str, default=None)# finetune_liuyuan_ad_nc_ad_T1
    ...
    parser.add_argument("--disease_num", type=int, default=3) # NC MCI AD

    args = parser.parse_args()
    main(args)


# torchrun --nnodes=1 --nproc_per_node=1  finetune_liuyuan_ad_nc_mci_ad_T1_step.py