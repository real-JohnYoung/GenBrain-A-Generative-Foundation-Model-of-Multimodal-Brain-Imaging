...
def main(args):
    ...
    transform = True
    dataset = UKBDataset_multisite_scz_finetune_T1(args.data_path, args.data_label_file, image_data_info, transform=transform)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default=None)# multisite_scz/T1_images dataset
    parser.add_argument("--data_label_file", type=str, default=None)# multisite_scz/labels/train_data.csv
    parser.add_argument("--data_info", type=str, default="../labels/data_info.json")
    parser.add_argument("--epochs", type=int, default=1000)
    parser.add_argument("--results_dir", type=str, default=None)# multisite_scz_finetune
...
# torchrun --nnodes=1 --nproc_per_node=1 finetune_multisite_scz_T1_step.py