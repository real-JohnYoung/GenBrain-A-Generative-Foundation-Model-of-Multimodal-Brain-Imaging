...
from model_utils import UKBDataset_T1_super_resolution_syn,PatchEmbed_1d
import json
import numpy as np
...
def main(args):
    ...
    dataset = UKBDataset_T1_super_resolution_syn(args.data_path, args.data_file, transform=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_file", type=str) # synthetic file
...
# super-resolution for synthetic images