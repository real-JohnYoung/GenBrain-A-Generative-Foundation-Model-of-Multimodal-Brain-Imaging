...
def load_corrupt_images(cor_data_path,eid_batch,modality_batch,device):
    ...
    for i in range(sub_num):
        ...
        if modality == 11:
            ...
            modality_name = 'T2_brain_2mm_stdspace' # flair
...
def main(args):
    ...
    eid_labels = sample_data['eid'].astype(str).tolist()
...
def save_batch_data(eid_batch,modality_batch, data, save_dir, image_data_info, sample_num):
    ...
    for i in range(sub_num):
        ...
        if index == 11:
            modality = 'T1_brain_2mm_stdspace'
        elif index == 13:
            modality = 'T2_brain_2mm_stdspace'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cor_data_path", type=str, default="./demo_dataset")
    ...
    parser.add_argument("--sample_file", type=str, default="./labels/demo_dataset.csv")
