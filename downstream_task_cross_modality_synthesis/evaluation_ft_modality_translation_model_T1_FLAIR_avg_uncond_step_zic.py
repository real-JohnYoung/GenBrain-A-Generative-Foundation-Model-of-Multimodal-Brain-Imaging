...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str) # zic dataset
    ...
    parser.add_argument("--sample_file", type=str)#zic_file
    ...
    parser.add_argument("--source_modality_index", type=int, default=11)
    parser.add_argument("--target_modality_index", type=int, default=13)
