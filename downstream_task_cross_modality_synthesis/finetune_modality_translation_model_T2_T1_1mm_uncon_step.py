...
def main(args):
    ...
    transform = True
    dataset = UKBDataset_modality_translation_T2_T1_1mm_finetune_uncon(args.data_path, args.data_file, transform=transform)
...
# torchrun --nnodes=1 --nproc_per_node=2 finetune_modality_translation_model_T2_T1_1mm_uncon_step.py