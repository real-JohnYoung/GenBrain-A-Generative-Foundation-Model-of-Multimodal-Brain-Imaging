...
def main(args):
    ...
    transform = True
    dataset = UKBDataset_modality_translation_T1_T2_finetune_uncon(args.data_path, args.data_file, args.label_file, transform=transform)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str) # ukb multimodal brain
...
# torchrun --nnodes=1 --nproc_per_node=1 finetune_modality_translation_model_T1_T2_uncon_step.py