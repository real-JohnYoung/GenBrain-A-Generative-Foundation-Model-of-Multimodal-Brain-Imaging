...
from model_utils import UKBDataset_istbi_depression_vbm_finetune
...
def main(args):
    ...
    transform = True
    dataset = UKBDataset_istbi_depression_vbm_finetune(args.data_path, args.data_label_file, image_data_info, transform=transform)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default=None)# processed_data_smooth dir
    ...
    parser.add_argument("--results_dir", type=str, default=None)# e.g. one_site_finetune_S25
    ...
    parser.add_argument("--disease_num", type=int, default=2) # NC Depression

    args = parser.parse_args()
    main(args)


# torchrun --nnodes=1 --nproc_per_node=1 finetune_mdd_one_site_vbm.py