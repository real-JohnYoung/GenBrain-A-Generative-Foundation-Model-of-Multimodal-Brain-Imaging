...
from model_utils import UKBDataset_multisite_scz_vbm_finetune
...
def main(args):
    ...
    transform = True
    dataset = UKBDataset_multisite_scz_vbm_finetune(args.data_path, args.data_label_file, image_data_info, transform=transform)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default=None) #processed_data
    parser.add_argument("--data_label_file", type=str, default=None)# COBRE_one_site_all_data.csv
    parser.add_argument("--data_info", type=str, default=None)# data_info.json
    parser.add_argument("--epochs", type=int, default=4000)
    parser.add_argument("--results_dir", type=str, default=None)# e.g. one_site_finetune_COBRE
    ...
    parser.add_argument("--disease_num", type=int, default=2) # NC SCZ
