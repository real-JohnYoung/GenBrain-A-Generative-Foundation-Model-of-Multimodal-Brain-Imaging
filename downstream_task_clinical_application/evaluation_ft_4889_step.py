...
import argparse
import pandas as pd
from models import DiT_models,LabelEmbedder,NumericalEmbedder
import json
import numpy as np
...
def main(args):
    ...
    score_info = {'mean':7.89,'std':7.91}
    finetune_mode = args.finetune_mode
    finetune_block = args.finetune_block

    model = DiT_UKB_finetune(dit_model,score_info,finetune_mode,finetune_block)
    model.dit_model.y3_embedder = ExtendedLabelEmbedder(model.dit_model.y3_embedder,n_new_modalities=1) # ADC : 35
    ...
    score_labels = sample_data['nihss'].astype(float).tolist()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=str, default=None)# heckpoints/step_0010000.pt
