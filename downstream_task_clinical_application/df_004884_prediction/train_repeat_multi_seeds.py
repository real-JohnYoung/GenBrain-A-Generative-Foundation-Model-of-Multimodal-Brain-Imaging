    ...
    for seed in seeds:
        for ratio in np.arange(0, 3.01, 0.1):
            ...
            best_val_mae, best_val_corr, test_mae, test_corr, best_epoch = main(
                real_train_img_dir = '/Path_to/clinical_application_stroke/ds_004884_dataset/process_1d',
                real_train_csv     = '/Path_to/downstream_clinical_application_stroke/ds_4884_labels/training_dataset.csv',
                gen_train_img_dir  = '/Path_to/clinical_application_stroke/ds_004884_results_new/000-DiT-UKB-L-256-finetune_mode-full/evaluations/step_10000',
                gen_train_csv      = '/Path_to/downstream_clinical_application_stroke/ds_4884_labels/data_aug_file.csv',
                val_img_dir        = '/Path_to/clinical_application_stroke/ds_004884_dataset/process_1d',
                val_csv            = '/Path_to/downstream_clinical_application_stroke/ds_4884_labels/validation_dataset.csv',
                test_img_dir       = '/Path_to/clinical_application_stroke/ds_004884_dataset/process_1d',
                test_csv           = '/Path_to/downstream_clinical_application_stroke/ds_4884_labels/testing_dataset.csv',
                model_save_dir     = f'/Path_to/clinical_application_stroke/ds_004884_results_new/resnet_2k_random_new_{seed}_{lr}_batch_8',
                batch_size = 8,
                ratio = ratio,
                lr = lr,
                epochs = 50,
            ...
            pd.DataFrame(results).to_csv(
                f'path_to/clinical_application_stroke/ds_004884_results/resnet_2k_random_new_{seed}_{lr}_batch_8/ratio_results_new_20k_random_seed.csv',
                index=False
            )
