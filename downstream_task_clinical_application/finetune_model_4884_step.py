...
from model_utils import UKBDataset_clinical_4884_finetune
...
def main(args):
    ...
    transform = True
    dataset = UKBDataset_clinical_4884_finetune(args.data_path, args.data_label_file, image_data_info, transform=transform)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default=None)# ds_004884_dataset/process_1d data dir
    parser.add_argument("--data_label_file", type=str, default=None)# /ds_4884_labels/training_dataset.csv"
...
# torchrun --nnodes=1 --nproc_per_node=1 finetune_model_4884_step.py